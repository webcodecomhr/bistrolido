	...
	$.fn.anythingSliderFx = function(effects, options){
		...
		getBaseFx = function(s){
			...
			return {
				...
				'caption-Top'    : [{ inFx: { top: 0, opacity: 0.9 }, outFx: { top: ( '-' + size || -50 ), opacity: 0 } }],
				'caption-Right'  : [{ inFx: { right: 0, opacity: 0.9 }, outFx: { right: ( '-' + size || -150 ), opacity: 0 } }],
				'caption-Bottom' : [{ inFx: { bottom: 0, opacity: 0.9 }, outFx: { bottom: ( '-' + size || -50 ), opacity: 0 } }],
				'caption-Left'   : [{ inFx: { left: 0, opacity: 0.9 }, outFx: { left: ( '-' + size || -150 ), opacity: 0 } }],
				
				'caption-Top-Standard'    : [{ inFx: { top: 55, opacity: 1 }, outFx: { top: ( '-' + size || -50 ), opacity: 0 } }],
				'caption-Right-Standard'  : [{ inFx: { right: 25, opacity: 1 }, outFx: { right: ( '-' + size || -150 ), opacity: 0 } }],
				'caption-Bottom-Standard' : [{ inFx: { bottom: 35, opacity: 1 }, outFx: { bottom: ( '-' + size || -50 ), opacity: 0 } }],
				'caption-Left-Standard'   : [{ inFx: { left: 25, opacity: 1 }, outFx: { left: ( '-' + size || -150 ), opacity: 0 } }],

				'caption-Right-Full'  : [{ inFx: { right: (Math.abs(jQuery(window).width()-966))/2, opacity: 1 }, outFx: { right: ( '-' + size || -150 ), opacity: 0 } }],
				'caption-Left-Full'   : [{ inFx: { left: (Math.abs(jQuery(window).width()-966))/2, opacity: 1 }, outFx: { left: ( '-' + size || -150 ), opacity: 0 } }]
			};
		};
