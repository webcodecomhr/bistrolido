...
(function() {
    ...
    var megatron_ref = null;
    
    tinymce.create('tinymce.plugins.shortcodeslist', {
        init: function(ed) {
                ...
                onselect : function(v) {
                    ...
                    if(v!=''){
                        ...
                        if(v == 'mls_bullet_list'){
                            megatron_ref.applyList('UL', 'OL', {'class':'bullets'})
                        }else if(v == 'mls_star_list'){
                            megatron_ref.applyList('UL', 'OL', {'class':'stars'})
                        }else if(v == 'mls_arrow_list'){
                            megatron_ref.applyList('UL', 'OL', {'class':'arrows'})
                        }else if(v == 'mls_ok_list'){
                            megatron_ref.applyList('UL', 'OL', {'class':'checklist'})
                        }else{
                            megatron_ref.applyList('OL', 'UL', {'class':'list'})
                        }
                        return false;                                
                    }
                }
        ...
        applyList: function(targetListType, oppositeListType, listClassObj) {   
            ...
            function makeList(element) {
                var list = dom.create(targetListType, listClassObj), li;
        ...
        getInfo: function() {
            return {
                longname : 'Shortcodes Lists',
                author : 'Moxiecode Systems AB feet milos',
    ...
    tinymce.PluginManager.add("shortcodeslist", tinymce.plugins.shortcodeslist); 
}());
